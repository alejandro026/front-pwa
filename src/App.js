  ...
  const handleCrear = () => {
    ...
    .then(() => {
      ...
      Swal.fire({
          ...
          text: `La adopción de ${nombreAdoptante} se guardó con éxito`,
          icon: "success",
      });
    })
    .catch(error => {
...
const handleEditar = () => {
  ...
  .then(() => {
    ...
    Swal.fire({
        ...
        text: `La adopción de ${nombreAdoptante} se actualizo con éxito`,
        icon: "success",
    });
  })
  .catch(error => {
          ...
          <div className='card-body'>
            <div className='row mb-3'>
              <div className='col-sm-3'>
                <label className='form-lable'>Nombre del Adoptante</label>
              </div>
            ...
            <div className='row mb-3'>
              <div className='col-sm-3'>
                <label className='form-lable'>Telefono</label>
              </div>
              <div className='col-sm-9'>
                <input
                  type='text'
            ...
            <div className='row mb-3'>
              <div className='col-sm-3'>
                <label className='form-lable'>Correro Electrónico</label>
              </div>
              <div className='col-sm-9'>
                <input
                  type='text'
            ...
            <div className='row mb-3'>
              <div className='col-sm-3'>
                <label className='form-lable'>Domicilio</label>
              </div>
              <div className='col-sm-9'>
                <input
                  type='text'
            ...
            <div className='row mb-3'>
              <div className='col-sm-3'>
                <label className='form-lable'>Mascota:</label>
              </div>
              <div className='col-sm-9'>
                <input
                  type='text'
            ...
            <div className='row mb-3'>
              <div className='col-sm-3'>
                <label className='form-lable'>Caracteristicas Preferidas:</label>
              </div>
              <div className='col-sm-9'>
                <input
                  type='text'
            ...
            <div className='row mb-3'>
              <div className='col-sm-3'>
                <label className='form-lable'>¿Por que está interesado en adoptar?</label>
              </div>
              <div className='col-sm-9'>
                <input
                  type='text'
